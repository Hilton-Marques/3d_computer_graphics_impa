...
# for pt in train_dataset.data:
#   plt.plot(pt[0].item(), pt[1].item(),'o')
...
def plot_comparison(f, model, interval=(-10, 10), nsamples=25, return_array=True):
